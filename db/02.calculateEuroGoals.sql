...
DROP PROCEDURE CALCULATE_GOALS IF EXISTS;
...
UPDATE EUROLEAGUE_GAMES set GOALS_HOME = v_goalshome, GOALS_AWAY = v_goalsaway, POINTS_HOME = v_playerhomepoints, POINTS_AWAY = v_playerawaypoints, UPDATE_DTM = NOW()  WHERE EUROLEAGUE_GAMES.ID = v_updateid;
