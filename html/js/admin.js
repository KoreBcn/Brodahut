...
function loadPayHistTable(){
	...
	payhisttable = new Tabulator("#pay-hist", {
		...
		columns:[
			...
			{title:"Valor d'equip",visible:false, field:"teamval", sortable:true, sorter:"number",width: 130, editor:"input", align:"center", formatter:formatCell},
			{title:"Salaris", field:"penal", sorter:"string", sortable:true, align:"center", formatter:formatCell},
			{title:"Saldo actual",visible:false, field:"balance", sortable:true, sorter:"number",width: 130 ,editor:"input",align:"center", formatter:formatCell},
