...
$sql = "SELECT PLAYER_NAME,PLAYER_DESC,PLAYERS_INFO.REPUTATION,si.REPUTATION,SPONSORS.SRC_LOGO,TV_RIGHTS.SRC_LOGO,LEAGUE,CHAMPIONS,UEFA,CUP,EUROPCUP,WORLDCUP FROM PLAYERS_INFO LEFT JOIN SPONSORS ON PLAYERS_INFO.SPONSOR = SPONSORS.ID left join TV_RIGHTS on TV_RIGHTS.ID = PLAYERS_INFO.TV_RIGHTS left join STADIUM_INFO si on si.PLAYER_ID = PLAYERS_INFO.PLAYER_ID order by si.player_id";
